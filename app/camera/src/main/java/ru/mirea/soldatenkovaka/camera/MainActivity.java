package ru.mirea.soldatenkovaka.camera;
...
import ru.mirea.soldatenkovaka.camera.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private File createImageFile() throws IOException {
        ...
        // Создаем папку
        File imageDir = new File(storageDirectory, "Images");
        if (!imageDir.exists()) {
            imageDir.mkdirs();
        }
